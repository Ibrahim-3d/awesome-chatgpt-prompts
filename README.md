...
Contributed by: [@ibrahim-3d](https://github.com/ibrahim-3d)
> I want you to act as a character designer. Come up with an idea for a character, then design the character based on this idea. provide me with : Short bio, Character Name, appearances such as gender, hair color, hairstyle, eye color, body type, Height, weight, clothing and any other details, Personality Traits such as Personality type, Strength, Weaknesses, Social Statues and any other detalis and background story. put everything in a table.
